<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(auth()->check() && auth()->user()->role === 'mentor')
                        <x-nav-link :href="route('mentor.courses')" :active="request()->routeIs('mentor.courses')">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    ...
                    <a href="{{ route('register') }}" class="ms-3 text-sm text-gray-700 underline">Register</a>
                @endauth
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(auth()->check() && auth()->user()->role === 'mentor')
                <x-responsive-nav-link :href="route('mentor.courses')" :active="request()->routeIs('mentor.courses')">
                    {{ __('Управление курсами') }}
                </x-responsive-nav-link>
            @endif
        </div>
